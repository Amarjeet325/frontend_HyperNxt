  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-14">
      ...
      <div className="flex items-center justify-between mb-10">
        <h2 className="text-2xl font-light text-gray-700">Best selling products</h2>
      ...
      {/* Products */}
     <div className="flex gap-4 overflow-x-auto lg:grid lg:grid-cols-6 lg:gap-4 scrollbar-hide">
